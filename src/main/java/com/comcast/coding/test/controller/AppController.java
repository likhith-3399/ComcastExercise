    ...
    * */
     ...
     * */
      ...
      * */
      ...
      public
      @ResponseBody
      ResponseEntity<String> insertMovieDetails(@RequestBody MovieDetailsEntity entity) {
          ...
          return new ResponseEntity<String>("Record Successfully Created for movie :"+entity.getMovieName(), HttpStatus.CREATED);
      }
       ...
       * */
       ...
       public
       @ResponseBody
       List<MovieDetailsEntity> viewAllMovieDetails() {
        ...
        * */
        ...
        public
        @ResponseBody
        ResponseEntity<Optional<MovieDetailsEntity>> viewMovieDetailsByMovieId(@PathVariable("movieId") Integer movieId) {
        ...
        * */
        ...
        public
        @ResponseBody
        ResponseEntity<List<MovieDetailsEntity>> viewMovieDetailsByMovieName(@PathVariable("movieName") String movieName) {
         ...
         * */
         ...
         public
         @ResponseBody
         ResponseEntity<String> deleteSingleMovieDetails(@PathVariable("movieName") String movieName) {
         ...
         * */
         ...
         public
         @ResponseBody
         ResponseEntity<String> deleteAllMovieDetails() {
          ...
          * */
          ...
          public
          @ResponseBody
          ResponseEntity<Post> consumeExternalRestAPI() {
